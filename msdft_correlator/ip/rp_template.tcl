...
startgroup
    ...
    set_property -dict [list CONFIG.NUM_SI {1} CONFIG.NUM_MI {7}] [get_bd_cells intercon0]
endgroup
...
startgroup
    ...
    set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_M00_AXI_Reg}];
    set_property offset 0x43c00000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M00_AXI_Reg}] ;
    ...
    set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_M01_AXI_Reg}];
    set_property offset 0x43c10000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M01_AXI_Reg}] ;
    ...
    make_bd_intf_pins_external -name "M02_AXI" [get_bd_intf_pins intercon0/M02_AXI]
    set_property CONFIG.PROTOCOL AXI4LITE [get_bd_intf_ports /M02_AXI]
    
    assign_bd_address [get_bd_addr_segs {M02_AXI/Reg }]
    set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_M02_AXI_Reg}];
    set_property offset 0x43c20000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M02_AXI_Reg}] ;
    
    apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config {Clk "/processing_system7_0/FCLK_CLK0 (125 MHz)" }  [get_bd_pins intercon0/M02_ACLK]

    make_bd_intf_pins_external -name "M03_AXI" [get_bd_intf_pins intercon0/M03_AXI]
    set_property CONFIG.PROTOCOL AXI4LITE [get_bd_intf_ports /M03_AXI]
    
    assign_bd_address [get_bd_addr_segs {M03_AXI/Reg }]
    set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_M03_AXI_Reg}];
    set_property offset 0x43c30000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M03_AXI_Reg}] ;
    
    apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config {Clk "/processing_system7_0/FCLK_CLK0 (125 MHz)" }  [get_bd_pins intercon0/M03_ACLK]

    make_bd_intf_pins_external -name "M04_AXI" [get_bd_intf_pins intercon0/M04_AXI]
    set_property CONFIG.PROTOCOL AXI4LITE [get_bd_intf_ports /M04_AXI]
    
    assign_bd_address [get_bd_addr_segs {M04_AXI/Reg }]
    set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_M04_AXI_Reg}];
    set_property offset 0x43c40000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M04_AXI_Reg}] ;
    
    apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config {Clk "/processing_system7_0/FCLK_CLK0 (125 MHz)" }  [get_bd_pins intercon0/M04_ACLK]

    make_bd_intf_pins_external -name "M05_AXI" [get_bd_intf_pins intercon0/M05_AXI]
    set_property CONFIG.PROTOCOL AXI4LITE [get_bd_intf_ports /M05_AXI]
    
    assign_bd_address [get_bd_addr_segs {M05_AXI/Reg }]
    set_property range 64K [get_bd_addr_segs {processing_system7_0/Data/SEG_M05_AXI_Reg}];
    set_property offset 0x43c50000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M05_AXI_Reg}] ;
    
    apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config {Clk "/processing_system7_0/FCLK_CLK0 (125 MHz)" }  [get_bd_pins intercon0/M05_ACLK]

    make_bd_intf_pins_external -name "M06_AXI" [get_bd_intf_pins intercon0/M06_AXI]
    set_property CONFIG.PROTOCOL AXI4LITE [get_bd_intf_ports /M06_AXI]
    
    assign_bd_address [get_bd_addr_segs {M06_AXI/Reg }]
    set_property range 32K [get_bd_addr_segs {processing_system7_0/Data/SEG_M06_AXI_Reg}];
    set_property offset 0x43c60000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M06_AXI_Reg}] ;
    
    apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config {Clk "/processing_system7_0/FCLK_CLK0 (125 MHz)" }  [get_bd_pins intercon0/M06_ACLK]

endgroup

set_property CONFIG.ASSOCIATED_BUSIF {M00_AXI:M01_AXI:M02_AXI:M03_AXI:M04_AXI:M05_AXI:M06_AXI} [get_bd_ports /axi_clock]
