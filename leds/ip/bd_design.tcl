...
apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config {Clk "/processing_system7_0/FCLK_CLK0 (125 MHz)" }  [get_bd_pins axi_interconnect_0/M01_ACLK]
endgroup

set_property CONFIG.ASSOCIATED_BUSIF {M00_AXI_0} [get_bd_ports /axi_clock]
set_property CONFIG.ASSOCIATED_BUSIF {M00_AXI_0:M01_AXI_0} [get_bd_ports /axi_clock]

##asign address 
assign_bd_address [get_bd_addr_segs {M01_AXI_0/Reg }]
set_property offset 0x41000000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M01_AXI_0_Reg}] ;	#base addr
set_property range 32K [get_bd_addr_segs {processing_system7_0/Data/SEG_M01_AXI_0_Reg}];		#size

assign_bd_address [get_bd_addr_segs {M00_AXI_0/Reg }]
set_property offset 0x41100000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M00_AXI_0_Reg}]
set_property range 32K [get_bd_addr_segs {processing_system7_0/Data/SEG_M00_AXI_0_Reg}]
