...
startgroup
    ...
    set_property range 32K [get_bd_addr_segs {processing_system7_0/Data/SEG_M00_AXI_Reg}];
    ...
    set_property range 32K [get_bd_addr_segs {processing_system7_0/Data/SEG_M01_AXI_Reg}];
    set_property offset 0x43c08000 [get_bd_addr_segs {processing_system7_0/Data/SEG_M01_AXI_Reg}] ;
